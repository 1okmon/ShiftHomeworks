...
enum Theme {
    ...
    static let collectionViewBackgroundColor = UIColor.color(light: .lightGray, dark: .gray)
    ...
    static let tableViewSeparatorColor = UIColor.color(light: .gray, dark: .lightGray)
